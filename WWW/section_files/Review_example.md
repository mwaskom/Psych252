...
## Data: df
## Models:
## rs_glm: COMB ~ SES + (1 | class)
## rs2_glm: COMB ~ SES + (1 + SES | class)
##         Df AIC BIC logLik deviance Chisq Chi Df Pr(>Chisq)  
## rs_glm   3 189 206  -91.3      183                          
## rs2_glm  5 184 213  -87.2      174  8.38      2      0.015 *
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Formula: COMB ~ SES + (1 + SES | class) 
##    Data: df 
## 
##      AIC      BIC   logLik deviance 
##   184.32   212.99   -87.16   174.32 
## 
## Random effects:
##  Groups Name        Variance Std.Dev. Corr 
##  class  (Intercept) 238.3    15.4          
##         SES          29.2     5.4     -1.00
## Number of obs: 2287, groups: class, 133
## 
## Fixed effects:
##             Estimate Std. Error z value Pr(>|z|)
## (Intercept)   -6.657     23.896   -0.28     0.78
## SES           -0.431      1.969   -0.22     0.83
## 
## Correlation of Fixed Effects:
##     (Intr)
## SES -0.958
