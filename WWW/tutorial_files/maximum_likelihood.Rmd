...
Suppose we wish to estimate the parameter of a coin, $p$ = Prob (Head on a toss); we will label out estimate as $\hat{p}$. We might toss the coin $n = 100$ times and observe $r = 45$ Heads. A familiar estimate of $p$ is: $$\hat{p}=\frac{r}{n}=\frac{45}{100}=0.45$$  
