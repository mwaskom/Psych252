...
2014 TAs: Rebecca Carey, Caitie Handron, Kara Weisman, Daniel Hawthorne, Steph Gagnon, Alyssa Fu, Kevin Mickey, Eric Miller
...
```{r plot_agecat0, fig.width=7, fig.height=6}
...
```{r plot_agedist, fig.width=7, fig.height=6}
...
```{r plot_optmism_on_age, fig.width=7, fig.height=6}
...
```{r plot_optmism_on_age_reg, fig.width=7, fig.height=6}
...
```{r plot_optmism_on_age_lm, fig.width=7, fig.height=6}
plot(rs2)
```
...
```{r plot_flu_df, fig.width=7, fig.height=6}
...
```{r plot_shot_on_aware, fig.width=7, fig.height=6}
...
```{r qplot_num_on_score, fig.width=9, fig.height=6}
...
```{r qplot_num_on_score_facet_levels, fig.width=9, fig.height=6}
...
```{r qplot_exploration, fig.width=9, fig.height=6}
