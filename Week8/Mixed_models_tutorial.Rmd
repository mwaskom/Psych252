...
read.csv('http://www.bodowinter.com/tutorial/politeness_data.csv') -> d
```
...
politeness.model = lmer(pitch ~ condition + (1|subject) + (1|scenario), data=d);
...
```{r}
politeness.model2 = lmer(pitch ~ condition + gender + (1|subject) + 
(1|scenario), data=d) 
...
```{r}
politeness.model.int = lmer(pitch ~ condition * gender + (1|subject) + (1|scenario), data=d) 
