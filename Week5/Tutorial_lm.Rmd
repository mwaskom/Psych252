...
```{r}
with(state,coplot(Income~ scale(Murder, scale=FALSE)|scale(Illiteracy, scale=FALSE)))
...
with(state,coplot(Income~ scale(Illiteracy, scale=FALSE) | scale(Murder, scale=FALSE)))
```