...
## ((10-10.47)^2)/10.47+((10-10.95)^2)/10.95+((10-8.57)^2)/8.57+((12-11.52)^2)/11.52+((13-12.04)^2)/12.04+((8-9.42)^2)/9.42
...
# Variances are different no matter how we look at them!
```
...
# Lets see how ignoring the transformation might have affected our results
...
# With the variable coded as it was the test is never significant. Pehaps because the distributions are not normal. 
```
